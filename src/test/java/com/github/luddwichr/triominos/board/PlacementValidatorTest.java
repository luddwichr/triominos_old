...
class PlacementValidatorTest {
	...
	void isValidPlacement_leftCorner_leftNeighbor() {
		Placement leftNeighbor = new Placement(new Tile(1, 2, 3), Orientation.ABC, new Location(0, 0));
		initializeWith(leftNeighbor);

		Placement nextValidPlacement = new Placement(new Tile(2, 0, 3), Orientation.ACB, new Location(0, 1));
		Placement nextInvalidPlacement = new Placement(new Tile(1, 0, 3), Orientation.ACB, new Location(0, 1));
	...
	void isValidPlacement_leftCorner_middleNeighbor() {
		Placement middleNeighbor = new Placement(new Tile(1, 2, 3), Orientation.ABC, new Location(0, 0));
		initializeWith(middleNeighbor);

		Placement nextValidPlacement = new Placement(new Tile(1, 3, 0), Orientation.ACB, new Location(-1, 0));
		Placement nextInvalidPlacement = new Placement(new Tile(2, 3, 0), Orientation.ACB, new Location(-1, 0));
		assertThat(isValidPlacement(nextValidPlacement)).isTrue();
		assertThat(isValidPlacement(nextInvalidPlacement)).isFalse();
	}
	...
	void isValidPlacement_leftCorner_leftToMiddleNeighbor() {
		Placement rightNeighbor = new Placement(new Tile(1, 2, 3), Orientation.ABC, new Location(0, 0));
		Placement leftToMiddleNeighbor = new Placement(new Tile(0, 0, 4), Orientation.ACB, new Location(1, -2));
		initializeWith(rightNeighbor, leftToMiddleNeighbor);

		Placement nextValidPlacement = new Placement(new Tile(4, 2, 1), Orientation.ACB, new Location(0, -1));
		Placement nextInvalidPlacement = new Placement(new Tile(5, 2, 1), Orientation.ACB, new Location(0, -1));
		assertThat(isValidPlacement(nextValidPlacement)).isTrue();
		assertThat(isValidPlacement(nextInvalidPlacement)).isFalse();
	}
	...
	void isValidPlacement_leftCorner_farLeftNeighbor() {
		Placement rightNeighbor = new Placement(new Tile(1, 2, 3), Orientation.ABC, new Location(0, 0));
		Placement farLeftNeighbor = new Placement(new Tile(0, 4, 0), Orientation.ACB, new Location(0, -3));
	...
	void isValidPlacement_leftCorner_farLeftToMiddleNeighbor() {
		Placement rightNeighbor = new Placement(new Tile(1, 2, 3), Orientation.ABC, new Location(0, 0));
		Placement farLeftToMiddleNeighbor = new Placement(new Tile(0, 0, 4), Orientation.ABC, new Location(1, -3));
	...
	void isValidPlacement_rightCorner_rightNeighbor() {
		...
		Placement nextValidPlacement = new Placement(new Tile(0, 2, 1), Orientation.ACB, new Location(0, -1));
		Placement nextInvalidPlacement = new Placement(new Tile(0, 1, 1), Orientation.ACB, new Location(0, -1));
		assertThat(isValidPlacement(nextValidPlacement)).isTrue();
		assertThat(isValidPlacement(nextInvalidPlacement)).isFalse();
	}
	...
	void isValidPlacement_rightCorner_middleNeighbor() {
		...
		Placement nextValidPlacement = new Placement(new Tile(1, 3, 0), Orientation.ACB, new Location(-1, 0));
		Placement nextInvalidPlacement = new Placement(new Tile(1, 2, 0), Orientation.ACB, new Location(-1, 0));
		assertThat(isValidPlacement(nextValidPlacement)).isTrue();
		assertThat(isValidPlacement(nextInvalidPlacement)).isFalse();
	}
	...
	void isValidPlacement_rightCorner_rightToMiddleNeighbor() {
		Placement leftNeighbor = new Placement(new Tile(1, 2, 3), Orientation.ABC, new Location(0, 0));
		Placement rightToMiddleNeighbor = new Placement(new Tile(0, 0, 4), Orientation.ACB, new Location(1, 2));
		initializeWith(leftNeighbor, rightToMiddleNeighbor);

		Placement nextValidPlacement = new Placement(new Tile(2, 4, 3), Orientation.ACB, new Location(0, 1));
		Placement nextInvalidPlacement = new Placement(new Tile(2, 5, 3), Orientation.ACB, new Location(0, 1));
		assertThat(isValidPlacement(nextValidPlacement)).isTrue();
		assertThat(isValidPlacement(nextInvalidPlacement)).isFalse();
	}
	...
	void isValidPlacement_rightCorner_farRightNeighbor() {
		Placement leftNeighbor = new Placement(new Tile(1, 2, 3), Orientation.ABC, new Location(0, 0));
		Placement farRightNeighbor = new Placement(new Tile(4, 0, 0), Orientation.ACB, new Location(0, 3));
	...
	void isValidPlacement_rightCorner_farRightToMiddleNeighbor() {
		Placement leftNeighbor = new Placement(new Tile(1, 2, 3), Orientation.ABC, new Location(0, 0));
		Placement farRightToMiddleNeighbor = new Placement(new Tile(4, 0, 0), Orientation.ABC, new Location(1, 3));
	...
	void isValidPlacement_middleCorner_rightNeighbor() {
		...
		Placement nextValidPlacement = new Placement(new Tile(0, 2, 1), Orientation.ACB, new Location(0, -1));
		Placement nextInvalidPlacement = new Placement(new Tile(0, 2, 2), Orientation.ACB, new Location(0, -1));
		assertThat(isValidPlacement(nextValidPlacement)).isTrue();
		assertThat(isValidPlacement(nextInvalidPlacement)).isFalse();
	}
	...
	void isValidPlacement_middleCorner_leftNeighbor() {
		...
		Placement nextValidPlacement = new Placement(new Tile(2, 0, 3), Orientation.ACB, new Location(0, 1));
		Placement nextInvalidPlacement = new Placement(new Tile(2, 0, 2), Orientation.ACB, new Location(0, 1));
		assertThat(isValidPlacement(nextValidPlacement)).isTrue();
		assertThat(isValidPlacement(nextInvalidPlacement)).isFalse();
	}
	...
	void isValidPlacement_middleCorner_rightToOppositeMiddleNeighbor() {
		Placement middleNeighbor = new Placement(new Tile(1, 2, 3), Orientation.ABC, new Location(0, 0));
		Placement rightToOppositeMiddleNeighbor = new Placement(new Tile(4, 0, 0), Orientation.ACB, new Location(-2, 1));
		initializeWith(middleNeighbor, rightToOppositeMiddleNeighbor);

		Placement nextValidPlacement = new Placement(new Tile(1, 3, 4), Orientation.ACB, new Location(-1, 0));
		Placement nextInvalidPlacement = new Placement(new Tile(1, 3, 5), Orientation.ACB, new Location(-1, 0));
		assertThat(isValidPlacement(nextValidPlacement)).isTrue();
		assertThat(isValidPlacement(nextInvalidPlacement)).isFalse();
	}
	...
	void isValidPlacement_middleCorner_leftToOppositeMiddleNeighbor() {
		Placement middleNeighbor = new Placement(new Tile(1, 2, 3), Orientation.ABC, new Location(0, 0));
		Placement leftToOppositeMiddleNeighbor = new Placement(new Tile(0, 4, 0), Orientation.ACB, new Location(-2, -1));
	...
	void isValidPlacement_middleCorner_oppositeMiddleNeighbor() {
		Placement middleNeighbor = new Placement(new Tile(1, 2, 3), Orientation.ABC, new Location(0, 0));
		Placement oppositeMiddleNeighbor = new Placement(new Tile(0, 4, 0), Orientation.ABC, new Location(-2, 0));
	...
	void isValidPlacement_noAdjacentPlacement() {
		...
		Placement secondPlacement = new Placement(new Tile(2, 2, 2), Orientation.ABC, new Location(1, 1));
